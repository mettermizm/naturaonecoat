import { pushScopeId, popScopeId, createElementVNode, createStaticVNode, defineComponent, useCssVars, unref, ref, onUnmounted, computed, openBlock, createElementBlock, createVNode, createCommentVNode, normalizeClass, createBlock, renderSlot, Fragment } from "@histoire/vendors/vue";
...
import "./StoryResponsivePreview.vue_vue_type_style_index_0_scoped_true_lang.js";
...
const _hoisted_3 = { class: "htw-p-4 htw-h-full htw-relative" };
const _hoisted_4 = { class: "htw-w-full htw-h-full htw-border htw-border-gray-100 dark:htw-border-gray-800 htw-rounded-sm htw-relative" };
