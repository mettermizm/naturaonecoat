import { createTextVNode, createElementVNode, defineComponent, resolveComponent, resolveDirective, openBlock, createBlock, unref, withCtx, createVNode, withDirectives, vModelText, createElementBlock, Fragment, renderList, normalizeClass, toDisplayString, createCommentVNode } from "@histoire/vendors/vue";
...
const _hoisted_2 = /* @__PURE__ */ createTextVNode(" Rotate ");
const _hoisted_3 = { class: "htw-flex htw-gap-2 htw-px-4 htw-py-3" };
const _hoisted_4 = /* @__PURE__ */ createElementVNode("span", { class: "htw-opacity-50" }, "x", -1);
const _hoisted_5 = ["onClick"];
const _hoisted_6 = { class: "htw-ml-auto htw-opacity-70 htw-flex htw-gap-1" };
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(histoireConfig).responsivePresets, (preset, index) => {
              return openBlock(), createElementBlock("button", {
                ...
                createElementVNode("span", _hoisted_6, [
                  preset.width ? (openBlock(), createElementBlock("span", _hoisted_7, [
                    createTextVNode(toDisplayString(preset.width), 1),
                    !preset.height ? (openBlock(), createElementBlock("span", _hoisted_8, "px")) : createCommentVNode("", true)
