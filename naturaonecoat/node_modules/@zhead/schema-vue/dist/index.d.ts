...
declare type MaybeRefObject<T> = MaybeRef<T> | {
    [key in keyof T]?: MaybeRef<T[key]>;
};
declare type MetaFlatRef = MaybeRefObject<Partial<MetaFlat>>;
declare type InferArrayEntry<T> = T extends Array<infer U> ? U : T;
declare type ReffableArrayEntries<T> = MaybeRef<MaybeRef<MaybeRefObject<InferArrayEntry<T>>>[]>;
...
export { MaybeRef, MaybeRefObject, MetaFlatRef, ReactiveHead, defineHead };
